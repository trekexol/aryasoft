...
<ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
      <a class="nav-link active font-weight-bold" style="color: black;" id="contact-tab"  href="<?php echo e(route('orders.index')); ?>" role="tab" aria-controls="contact" aria-selected="false">Pedidos</a>
    </li>
    <li class="nav-item" role="presentation">
            ...
            <tbody>
                ...
                <?php else: ?>  
                    <?php $__currentLoopData = $quotations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quotation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                           <td class="text-center"><?php echo e($quotation->date_order ?? ''); ?></td>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?php echo e(route('orders.create_order',[$quotation->id,$quotation->coin])); ?>" title="Mostrar"><i class="fa fa-file-alt"></i></a>
                                <a href="<?php echo e(route('orders.reversar_order',$quotation->id)); ?>" title="Borrar"><i class="fa fa-trash text-danger"></i></a>
                           </td>
                        </tr>     
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aryasoftware\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>