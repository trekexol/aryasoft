    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('inventories.store_decrease_inventory')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="id_inventory" value="<?php echo e($inventory->id); ?>" readonly required autocomplete="id_inventory">
...
unset($__errorArgs, $__bag); ?>" name="amount" value="<?php echo e(number_format($inventory->amount, 2, ',', '.')); ?>" readonly required autocomplete="amount">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(number_format($inventory->products['price'], 2, ',', '.')); ?>" name="price" required autocomplete="price">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(number_format($bcv ?? 0, 2, ',', '.')); ?>" name="rate" required autocomplete="rate">
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aryasoftware\resources\views/admin/inventories/create_decrease_inventory.blade.php ENDPATH**/ ?>