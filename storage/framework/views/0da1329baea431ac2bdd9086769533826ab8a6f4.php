...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <a href="<?php echo e(route('orders.index')); ?>" id="btnfacturar" name="btnfacturar" class="btn btn-success" title="facturar">Ver Pedidos</a>  
                            </div>
...
<script type="text/javascript">
    ...
    {
        coin = $(this).val();
        window.location = "<?php echo e(route('orders.create_order', [$quotation->id,''])); ?>"+"/"+coin;
    });
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        var nuevaVentana= window.open("<?php echo e(route('pdf.order',[$quotation->id,$coin,'',''])); ?>"+"/"+inputIva+"/"+date,"ventana","left=800,top=800,height=800,width=1000,scrollbar=si,location=no ,resizable=si,menubar=no");
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aryasoftware\resources\views/admin/orders/create.blade.php ENDPATH**/ ?>