...
<body>
  <table>
    <tr>
      <th style="text-align: left; font-weight: normal; width: 15%; border-color: white; font-weight: bold;"> <img src="<?php echo e(asset($foto ?? 'img/northdelivery.jpg')); ?>" width="50%"  class="d-inline-block align-top" alt="">
      </th>
      <th style="text-align: left; font-weight: normal; width: 85%; border-color: white; font-weight: bold;"><h4><?php echo e($code_rif ?? ''); ?>  </h4></th>
    </tr> 
  </table>
...
<?php /**PATH C:\xampp\htdocs\aryasoftware\resources\views/admin/reports/balance_general.blade.php ENDPATH**/ ?>