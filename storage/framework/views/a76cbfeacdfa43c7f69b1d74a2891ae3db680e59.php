    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('quotations.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="id_client" value="<?php echo e($client->id ?? -1); ?>" required autocomplete="id_client">
                        <input id="id_vendor" type="hidden" class="form-control <?php $__errorArgs = ['id_vendor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="id_vendor" value="<?php echo e($vendor->id ?? $client->id_vendor ?? null); ?>" required autocomplete="id_vendor">
...
unset($__errorArgs, $__bag); ?>" name="date_quotation" value="<?php echo e($datenow); ?>" required autocomplete="date_quotation">
...
unset($__errorArgs, $__bag); ?>" name="serie" value="<?php echo e(old('serie')); ?>" autocomplete="serie">
...
unset($__errorArgs, $__bag); ?>" name="client" value="<?php echo e($client->name ?? ''); ?>" readonly required autocomplete="client">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-1">
                                <a href="<?php echo e(route('quotations.selectclient')); ?>" title="Seleccionar Cliente"><i class="fa fa-eye"></i></a>  
                            </div>
                            ...
                            <select class="form-control" id="id_transport" name="id_transport">
                                ...
                                <?php $__currentLoopData = $transports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $var): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($var->id); ?>"><?php echo e($var->placa); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group row">
                           <label for="vendors" class="col-md-2 col-form-label text-md-right">Vendedor</label>
                            <div class="col-md-3">
                                <input id="id_vendor" type="text" class="form-control <?php $__errorArgs = ['id_vendor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="vendor" value="<?php echo e($vendor->name ?? $client->vendors['name'] ?? ''); ?>" readonly required autocomplete="id_vendor">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-1">
                                <a href="<?php echo e(route('quotations.selectvendor',$client->id ?? -1)); ?>" title="Seleccionar Vendedor"><i class="fa fa-eye"></i></a>  
                            </div>
...
unset($__errorArgs, $__bag); ?>" name="note" value="<?php echo e(old('note')); ?>"  autocomplete="note">
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aryasoftware\resources\views/admin/quotations/createquotation.blade.php ENDPATH**/ ?>