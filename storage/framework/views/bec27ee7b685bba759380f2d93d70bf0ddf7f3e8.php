...
<?php if($errors->any()): ?>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form  method="POST"   action="<?php echo e(route('combos.update',$combo->id)); ?>" enctype="multipart/form-data" >
...
unset($__errorArgs, $__bag); ?>" name="description" value="<?php echo e($combo->description); ?>" required autocomplete="description">
                                    ...
                                    <div class="col-md-4">   
                                        <select id="segment" name="segment" class="form-control" required>
                                            <?php $__currentLoopData = $segments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $segment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if( $combo->segment_id == $segment->id   ): ?>
                                    ...
                                    <div class="col-md-4">
                                        <select id="subsegment" name="Subsegment" class="form-control" required>
                                            <?php $__currentLoopData = $subsegments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subsegment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if( $combo->subsegment_id == $subsegment->id   ): ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <select id="twosubsegment" name="twoSubsegment" class="form-control" >
                                                <?php if( isset($combo->twosubsegment_id) ): ?>
                                                    <option  selected style="backgroud-color:blue;" value="<?php echo e($combo->twosubsegments['id']); ?>"><strong><?php echo e($combo->twosubsegments['description']); ?></strong></option>
                                                <?php else: ?>
                                    ...
                                    <div class="col-md-4">
                                        <select id="threesubsegment" name="threeSubsegment" class="form-control" >
                                                <?php if( isset($combo->threesubsegments['id']) ): ?>
                                                    <option  selected style="backgroud-color:blue;" value="<?php echo e($combo->threesubsegments['id']); ?>"><strong><?php echo e($combo->threesubsegments['description']); ?></strong></option>
                                                <?php else: ?>
                                                    <option  selected style="backgroud-color:blue;" value="null"><strong>No tiene</strong></option>
                                                <?php endif; ?>
                                                <option disabled  style="backgroud-color:blue;"><strong>------------</strong></option>
                                     ...
                                     <div class="col-md-4">
                                        <select id="unit_of_measure_id" name="unit_of_measure_id" class="form-control" required>
                                            <?php $__currentLoopData = $unitofmeasures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $var): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if( $combo->unit_of_measure_id == $var->id   ): ?>
...
unset($__errorArgs, $__bag); ?>" name="code_comercial" value="<?php echo e($combo->code_comercial); ?>" required autocomplete="code_comercial">
...
unset($__errorArgs, $__bag); ?>" name="price" value="<?php echo e($combo->price); ?>" required autocomplete="price">
...
unset($__errorArgs, $__bag); ?>" name="price_buy" value="<?php echo e($combo->price_buy); ?>" required autocomplete="price_buy">
...
unset($__errorArgs, $__bag); ?>" name="cost_average" value="<?php echo e($combo->cost_average); ?>" required autocomplete="cost_average">
...
unset($__errorArgs, $__bag); ?>" name="special_impuesto" value="<?php echo e($combo->special_impuesto); ?>" required autocomplete="special_impuesto">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-md-2">
                                        <a href="<?php echo e(route('combos')); ?>" id="btnfacturar" name="btnfacturar" class="btn btn-danger" title="facturar">Volver</a>  
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aryasoftware\resources\views/admin/combos/edit.blade.php ENDPATH**/ ?>