        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
            <form  method="POST"   action="<?php echo e(route('quotations.productupdate',$quotation_product->id)); ?>" enctype="multipart/form-data" onsubmit="return validacion()">
                <?php echo method_field('PATCH'); ?>
                <?php echo csrf_field(); ?>

                    <input id="rate_quotation" type="hidden" class="form-control <?php $__errorArgs = ['rate_quotation'];
...
unset($__errorArgs, $__bag); ?>" name="rate_quotation" value="<?php echo e($quotation_product->rate ?? -1); ?>" readonly required autocomplete="rate_quotation"> 
...
unset($__errorArgs, $__bag); ?>" name="code" value="<?php echo e($quotation_product->inventories['code'] ?? old('code')); ?>" readonly required autocomplete="code" autofocus>
                        </div>
...
unset($__errorArgs, $__bag); ?>" name="description" value="<?php echo e($inventory->products['description'] ?? old('description')); ?>" readonly required autocomplete="description">
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>" name="amount_old" value="<?php echo e($inventory->amount); ?>" readonly required autocomplete="amount_old">
                        </div> 
                    </div>
                    <div class="form-group row">
...
unset($__errorArgs, $__bag); ?>" name="price" value="<?php echo e(number_format($quotation_product->price / ($rate ?? 1), 2, ',', '.')); ?>"  required autocomplete="price">
                        </div>  
...
unset($__errorArgs, $__bag); ?>" name="rate" value="<?php echo e(number_format($quotation_product->rate, 2, ',', '.')); ?>"  required autocomplete="rate">
                        </div>  
...
unset($__errorArgs, $__bag); ?>" name="amount" value="<?php echo e(number_format($quotation_product->amount, 0, ',', '.')); ?>" required autocomplete="amount">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-check">
                                            <?php if($quotation_product->retiene_iva == 1): ?>
                                     ...
                                     <div class="col-md-1">
                                            <div class="form-check">
                                                <?php if($quotation_product->retiene_islr == 1): ?>
                                     ...
                                     <div class="col-md-1">
                                         <input id="discount" type="text" class="form-control <?php $__errorArgs = ['discount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="discount" value="<?php echo e(number_format($quotation_product->discount, 0, ',', '.')); ?>" required autocomplete="discount">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-md-2">
                                        <a href="<?php echo e(route('quotations.create',[$quotation_product->id_quotation,$coin])); ?>" id="btnfacturar" name="btnfacturar" class="btn btn-danger" title="facturar">Volver</a>  
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aryasoftware\resources\views/admin/quotations/edit_product.blade.php ENDPATH**/ ?>