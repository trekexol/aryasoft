...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-sm-12">
            <div class="card">
                <form method="POST" action="<?php echo e(route('balanceingresos.store')); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="date_begin" value="<?php echo e(date('Y-m-d', strtotime($datebeginyear ?? $date_begin ??''))); ?>" required autocomplete="date_begin">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="<?php echo e(route('balanceingresos.balance_pdf',[$coin ?? 'bolivares',$datebeginyear ?? $date_begin ?? $datenow,$date_end ?? $datenow,$level ?? 5])); ?>" allowfullscreen></iframe>
                          </div>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aryasoftware\resources\views/admin/reports/index_ingresos_egresos.blade.php ENDPATH**/ ?>