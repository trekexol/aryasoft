...
<div class="container" >
    <div class="row justify-content-center" >
            ...
            <div class="card" style="width: 70rem;" >
                ...
                <form method="POST" action="<?php echo e(route('expensesandpurchases.store_expense_credit')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>   
                <div class="card-body" >
                            ...
                            <select class="form-control" name="islr_concept" id="islr_concept">
                                ...
                                <?php if(isset($islrconcepts)): ?>
                                    <?php $__currentLoopData = $islrconcepts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $islrconcept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($islrconcept->value); ?>"  data-id="<?php echo e($islrconcept->id); ?>" ><?php echo e($islrconcept->description); ?> - <?php echo e($islrconcept->value); ?>%</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                            </div>
...
unset($__errorArgs, $__bag); ?>" name="anticipo" placeholder="0,00" value="0" readonly required autocomplete="anticipo"> 
...
unset($__errorArgs, $__bag); ?>" name="credit" placeholder="Dias de Crédito" autocomplete="credit"> 
                        ...
                        <div class="form-group row" id="formenviarcredito">
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo e(route('expensesandpurchases.create',$expense->id_provider)); ?>" id="btnfacturar" name="btnfacturar" class="btn btn-danger" title="facturar">Volver</a>  
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row" id="enviarpagos">
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo e(route('expensesandpurchases.create_detail',[$expense->id,$coin])); ?>" id="btnfacturar" name="btnfacturar" class="btn btn-danger" title="Volver">Volver</a>  
                            </div>
                        </div>
...
<?php $__env->startSection('consulta'); ?>
    <script>
        ...
        $("#coin").on('change',function(){
            coin = $(this).val();
            window.location = "<?php echo e(route('expensesandpurchases.create_payment', [$expense->id,''])); ?>"+"/"+coin;
        });
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aryasoftware\resources\views/admin/expensesandpurchases/create_payment.blade.php ENDPATH**/ ?>