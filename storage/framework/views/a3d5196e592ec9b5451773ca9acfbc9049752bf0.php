                ...
                <tbody>
                    ...
                    <?php else: ?>  
                        <?php $__currentLoopData = $providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td >
                                    <a href="<?php echo e(route('reportspayment.payments',['Proveedor',$provider->id])); ?>"  title="Seleccionar"><i class="fa fa-check" style="color: orange"></i></a>
                                </td>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aryasoftware\resources\views/admin/reports_payment/selectprovider.blade.php ENDPATH**/ ?>