...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus maxlength="40"/>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo e(route('users')); ?>" id="btnvolver" name="btnvolver" class="btn btn-danger" title="volver">Volver</a>  
                            </div>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aryasoftware\resources\views/admin/users/create.blade.php ENDPATH**/ ?>