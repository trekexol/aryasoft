...
<div class="container-fluid">
    ...
    <div class="row py-lg-2">
        <div class="col-sm-8 h4">
            Listado de Comprobantes Contables detallados de la <br>cuenta: Nº <?php echo e($account->code_one); ?>.<?php echo e($account->code_two); ?>.<?php echo e($account->code_three); ?>.<?php echo e($account->code_four); ?>.<?php echo e($account->code_five); ?> / <?php echo e($account->description); ?>
            ...
            <tbody>
                ...
                <?php else: ?>
                    ...
                    <?php if(isset($var->id_invoice)): ?>
                        <td>Factura</td>
                        <td>
                        <a href="<?php echo e(route('accounts.header_movements',[$var->id_invoice,'invoice',$account->id])); ?>" title="Crear"><?php echo e($var->id_invoice); ?></a>
                        </td>
                    <?php elseif(isset($var->id_expense)): ?>
                        <td>Gasto o Compra</td>
                        <td>
                        <a href="<?php echo e(route('accounts.header_movements',[$var->id_expense,'expense',$account->id])); ?>" title="Crear"><?php echo e($var->id_expense); ?></a>
                        </td>
                    <?php elseif(isset($var->id_header_voucher)): ?> 
                        <td>Otro</td>
                        <td>
                        <a href="<?php echo e(route('accounts.header_movements',[$var->id_header_voucher,'header_voucher',$account->id])); ?>" title="Crear"><?php echo e($var->id_header_voucher); ?></a>
                        </td>
                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aryasoftware\resources\views/admin/accounts/index_account_movement.blade.php ENDPATH**/ ?>