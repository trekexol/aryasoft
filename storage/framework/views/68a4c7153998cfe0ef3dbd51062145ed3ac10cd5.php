...
<body>
  ...
  <h4 style="color: black">PEDIDO NRO: <?php echo e(str_pad($quotation->number_order ?? $quotation->id, 6, "0", STR_PAD_LEFT)); ?></h4>
...
<table>
  ...
  <tr>
    ...
    <td><?php echo e($quotation->date_delivery_note ?? ''); ?></td>
...
<table style="width: 100%;">
  ...
  <tr>
    ...
    <td style="text-align: center;"><?php echo e($quotation->clients['cedula_rif'] ?? ''); ?></td>
...
<?php /**PATH C:\xampp\htdocs\aryasoftware\resources\views/pdf/order.blade.php ENDPATH**/ ?>